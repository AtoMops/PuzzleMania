 ...
 * --> Symbole markieren und verschieben
...
public class PuzzleManiaAppV6 extends Application {
...
//				gamePane.add(createCircleForTesting(), j, i); // gamePane uses add(Node,x,y)
				gamePane.add(createImgViewForGamePane(), j, i); // gamePane uses add(Node,x,y)
			}
		}
...
//		rect.setStrokeWidth(5.0);
	...
	private ImageView createImgViewForGamePane() {
...
//		String imageToLoad = "alchemy";
		...
		int randLoad = getRandomNumberInRange(0, 1);
