 ...
 * --> Symbole markieren und verschieben --> Symbole switche geht
 * 		ABER: Noch trouble mit der CursorPane !! 
 * 			--> Translate des Cursors geht aber das wollen wir ja nicht wirklich ^^'
 * 				wir brauchen eine "AnimationPane" für Effekte
 * 
...
public class PuzzleManiaAppV7 extends Application {
...
//				System.out.println("id: " + id);
	...
	private void moveCursor(String direction) {
		...
		if(!fixedCursor) {
			...
			/*	hier brauchen wir shift der aktuellen Elements
			 * nur EINEN Schritt erlauben wenn Cursor aktiviert!!
			 */
