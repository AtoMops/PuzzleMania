 ...
 *
 *  --> TODO: Main-Menu mal aufpeppen
 *  		  das Background-Image muss irgendwie zu Mana-Battle passen
 *  			oder noch besser: Eine GIF als Background die Mana-Battle darstellt; keine Konzept-Art hier Mann ^^'
 * 			  Leichter Light-effect auf die Buttons; Menu wirkt sonst so unbelebt
 * 				FARBEN!! FAAAARBEEEEEENN!!! sieht noch zu häßlich aus ^^'			  
 * 
 * 
 * 
...
public class PuzzleManiaAppV14 extends Application {
