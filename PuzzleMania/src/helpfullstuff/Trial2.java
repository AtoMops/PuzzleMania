...
public class Trial2 {
	 ...
	 * 
	 * --> müsste eigentlich einfacher mit stream.map(e -> e.wasAuchImmer).etc zu lösen sein oO'
	 * 		zudem klappt das nur bei 8x8 maps aber wir wollen ja evtl auch mal größere maps haben
	 * 		aber geht erstmal 
	 */
	...
	// works mostly. Situation oben aber noch nicht
	/* --> Spezialfall?! 2 Reihen mit unterbrechung --> einfach nochmal testen?!
	 * also bei passender reihe die werte in zwischenliste 
	 * kann nur bei 6 und 7 treffern passieren 
	 */
